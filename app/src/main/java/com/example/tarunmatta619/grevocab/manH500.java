        ...
        imageButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mcount < 102){
                    ...
                    firebaseDatabase.getReferenceFromUrl("https://grevocab-5ba58.firebaseio.com/HighFrequency101/word/" +mcount).addValueEventListener(new ValueEventListener() {
                        @Override
                    ...
                    firebaseDatabase.getReferenceFromUrl("https://grevocab-5ba58.firebaseio.com/HighFrequency101/Meaning/" +mcount).addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mcount > 1){
                    ...
                    mcount--;
                    firebaseDatabase.getReference("HighFrequency101/word/" +mcount).addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    firebaseDatabase.getReference("HighFrequency101/Meaning/" +mcount).addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            String fmeaning = dataSnapshot.getValue(String.class);
                            meaning.setText(fmeaning);
